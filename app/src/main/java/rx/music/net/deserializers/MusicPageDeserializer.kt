...
internal class MusicPageDeserializer : JsonDeserializer<Response<MusicPage>> {
    companion object {
    ...
    override fun deserialize(json: JsonElement, typeOfT: Type, context: JsonDeserializationContext):
            Response<MusicPage> {
        if (typeOfT.toString().contains(MusicPage::class.java.canonicalName)) {
        ...
        return Gson().fromJson(JSONObject(json.asJsonObject.toString()).toString(), typeOfT)
    }
}